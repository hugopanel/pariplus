...
<div class="container" style="margin-top: 80px;">
    <div class="row">
        <div class="col-lg-8">
            <div class="bloc bloc-content">
                <h1>Prédiction de résultat</h1>
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-6">
                        <select id="teamSelect1" class="form-select">
                ...
                <button id="predictionButton" class="btn btn-primary" style="margin-bottom: 20px;">Prédiction</button>
                <div id="output" class="alert alert-primary">Résultat de la prédiction : </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="bloc">
    ...
    <div id="predictionButtonContainer">
    </div>
    <br>
</div>
...
<script src="data_match.js"></script>
</html>